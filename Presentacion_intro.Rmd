...
graf1=ggplot()+geom_line(aes(x=as.Date(data$`Calc Date`),y=as.numeric(as.character(data$`Price Close`)),col=data$Instrument))+xlab("Tiempo")+ylab("Precio ($)")+ggtitle("Serie de tiempo del precio de Grupo Bimbo y de Grupo CEMEX")+
